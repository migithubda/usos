...
wget -O fail2.tar.gz https://raw.githubusercontent.com/migithubda/usos/master/Install/fail2ban.tar.gz
 -o /dev/null
...
fail2ban_function () {
echo -e " \033[1;32m $(fun_trans "FAIL2BAN PROTECAO") [ADM - DAVID_VILLAN]"
echo -e "$barra"
if [[ -e /etc/fail2ban/jail.conf ]]; then
while true; do
echo -e "${cor[4]} [1] > \033[1;37m$(fun_trans "Ver registro de IP")s"
echo -e "${cor[4]} [2] > \033[1;37m$(fun_trans "Remover") fail2ban"
