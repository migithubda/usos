...
cd socks
patch="https://raw.githubusercontent.com/migithubda/usos/master/Install/backsocz"
arq="backsocz"
...
gettunel_fun () {
echo "master=°°°David_Villan°°°" > ${SCPinst}/pwd.pwd
...
screen -dmS getpy python ${SCPinst}/PGet.py -b "0.0.0.0:$1" -p "${SCPinst}/pwd.pwd"
 ...
 echo -e "\033[1;32m ADM - DAVID VILLAN"
 } || {
msg -bar
