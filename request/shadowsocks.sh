...
return 0
       ...
       echo -e "\033[1;32m $(fun_trans "INSTALADOR SHADOWSOCKS*")ADM °°°DAVID VILLAN°°°"
       msg -bar
       while true; do
       ...
       while true; do
       unset cript
       echo -ne " $(fun_trans "Qual Criptografia")? $(fun_trans "Escolha uma Opcao"): "; read -e -i 0 cript
       [[ ${encript[$cript]} ]] && break
...
#INICIANDO
msg -bar
msg -ama " $(fun_trans "Digite a Senha Shadowsocks")"
read -p" Pass: " Pass
msg -bar
