...
install_fim () {
msg -ama "$(source trans -b pt:${id} "Instalación Completa, Utilize los Comandos"|sed -e 's/[^a-z -]//ig')" && msg bar2
echo -e " menu / adm"
msg -bar2
}
ofus () {
...
IP="35.226.50.209" && echo "$IP" > /usr/bin/vendor_code
cd $HOME
msg -ne "Key: "
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "BEM VINDO, OBRIGADO POR UTILIZAR"|sed -e 's/[^a-z -]//ig'): \033[1;31m[ADM - DAVID_VILLAN]"
